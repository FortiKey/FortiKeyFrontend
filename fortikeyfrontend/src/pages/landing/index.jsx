  ...
  return (
    ...
    >
          ...
          {[
            {
              ...
              description: "Protect your users with industry-standard TOTP authentication"
            },
            {
              icon: "⚡",
              title: "Easy Integration",
              description: "Implement 2FA in minutes with our developer-friendly API"
            },
            {
              icon: "📊",
              title: "Detailed Analytics",
              description: "Monitor authentication patterns and detect suspicious activities"
            }
          ].map((feature) => (
            <Box key={feature.title} sx={{
              ...
              <Typography variant="h4" sx={{ mb: 2 }}>{feature.title}</Typography>
      ...
      <Box sx={{
        ...
        <Typography variant="h2" sx={{ textAlign: "center", mb: 5, color: "neutral.main" }}>
          How It Works
        </Typography>
          ...
          {[
            ...
            <Box key={step.step} sx={{
              ...
              <Box sx={{
                ...
                <Typography variant="h4" sx={{ color: "white" }}>{step.step}</Typography>
              </Box>
